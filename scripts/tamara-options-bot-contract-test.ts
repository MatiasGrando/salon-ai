...
assert.match(webhookSource, /conversationSnapshot: \{\s*supportBotState: leasedConversation\.supportBotState,\s*updatedAt: leasedConversation\.updatedAt,\s*phone: leasedConversation\.phone/s)

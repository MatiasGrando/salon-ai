  ...
  async planBookingAction(input: {
    ...
    const result = await this.askJson<AiBookingAgentResult>({
      instructions: [
        ...
        'Cuando pidas aclaracion sobre servicio o profesional, inclui opciones claras tomadas de las listas recibidas, sin sonar como formulario.',
        'Ejemplo: "Te referis a Corte Hombre o a Corte y color?"',

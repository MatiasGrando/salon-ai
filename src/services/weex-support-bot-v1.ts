...
const PLAN_PRICES: Record<string, string> = {
  '1': [
    '*Plan 1 · Agenda + CRM*',
    'Incluye:',
    '• Agenda inteligente y gestión de turnos.',
    '• Administración de profesionales y servicios.',
    '• Base de clientes en el CRM.',
    '• Historial de visitas.',
    '• Recordatorios automáticos.',
    '• Landing adaptable utilizando nuestras plantillas.',
    '',
  ...
  '2': [
    ...
    '• Agenda inteligente y gestión de turnos.',
    '• Administración de profesionales y servicios.',
    '• Base de clientes en el CRM e historial de visitas.',
    '• Recordatorios automáticos.',
    '• Bot por menús y opciones.',
    '• Atención y reservas automáticas las 24 horas.',
    '• Respuestas a preguntas frecuentes, confirmaciones y recordatorios.',
  ...
  '3': [
    ...
    '• Base de clientes en el CRM e historial de visitas.',
    '• Recordatorios automáticos.',
    '• Bot inteligente con interpretación de lenguaje natural.',
    '• Atención y reservas automáticas las 24 horas.',
    '• Respuestas personalizadas, sugerencias y recomendaciones.',
    '• Mayor precisión y contexto en las respuestas.',
    '• Derivación a una persona cuando sea necesario.',
    '• Landing adaptable utilizando nuestras plantillas.',
    '',
  ...
  '4': [
    ...
    '• Mayor precisión y contexto en las respuestas.',
    '• Derivación a una persona cuando sea necesario.',
    '• Landing creada desde cero según el diseño del cliente, con hosting propio incluido.',
    'El dominio se evalúa en la reunión porque su precio puede variar.',
    '',
  ...
  '5': [
    ...
    '• Un flujo principal.',
    '• Hasta 5 secciones en el menú principal.',
    '• Hasta 25 respuestas o caminos.',
    '• Una ronda de correcciones antes de activarlo.',
    '• Derivación a una persona.',
    '• Configuración en un número de WhatsApp.',
    '• Funcionamiento y mantenimiento básico.',
    '',

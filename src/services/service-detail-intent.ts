...
export function deterministicServiceInformationRequest(
  ...
  if (/\b(?:precio|precios|costo|costos|valor|valores|tarifa|tarifas|cuanto cuesta|cuanto sale|cuanto me cuesta|cuanto me sale|cuanto vale|que sale)\b/.test(normalized)) {

...
const tamaraAssets = [
  ...
  { url: '/partners/all-boys.png', file: join('partners', 'all-boys.png'), contentType: 'image/png' },
  { url: '/partners/centro-espanol.png', file: join('partners', 'centro-espanol.png'), contentType: 'image/png' },
  { url: '/partners/chacarita-juniors.png', file: join('partners', 'chacarita-juniors.png'), contentType: 'image/png' },
  { url: '/partners/chacarita-juniors.svg', file: join('partners', 'chacarita-juniors.svg'), contentType: 'image/svg+xml' },
  { url: '/partners/deportivo-espanol.png', file: join('partners', 'deportivo-espanol.png'), contentType: 'image/png' },
  { url: '/partners/deportivo-espanol.svg', file: join('partners', 'deportivo-espanol.svg'), contentType: 'image/svg+xml' },
  { url: '/partners/deportivo-riestra.png', file: join('partners', 'deportivo-riestra.png'), contentType: 'image/png' },
  { url: '/partners/deportivo-riestra.svg', file: join('partners', 'deportivo-riestra.svg'), contentType: 'image/svg+xml' },
  { url: '/partners/san-martin-burzaco.png', file: join('partners', 'san-martin-burzaco.png'), contentType: 'image/png' },
  { url: '/partners/san-telmo.png', file: join('partners', 'san-telmo.png'), contentType: 'image/png' },
  { url: '/partners/talleres-remedios-escalada.png', file: join('partners', 'talleres-remedios-escalada.png'), contentType: 'image/png' },

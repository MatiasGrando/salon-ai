...
export const appointmentFinanceMarkup = `
          ...
          <details class="appointment-finance" id="appointment-finance" hidden>
            ...
            <div class="appointment-finance-content">
              ...
              <section class="appointment-finance-form" id="appointment-total-form"><strong>Total definitivo</strong><small>Disponible porque este servicio tiene precio estimativo.</small><div class="appointment-finance-row"><label>Importe acordado<input id="appointment-estimated-total" type="number" min="0" step="1" inputmode="numeric"></label><span></span><button class="secondary" id="appointment-total-submit" type="button">Guardar total</button></div></section>
              ...
              <section class="appointment-finance-form" id="appointment-discount-form"><strong>Aplicar descuento</strong><div class="appointment-finance-row"><label>Tipo<select id="appointment-discount-type"><option value="AMOUNT">Monto</option><option value="PERCENTAGE">Porcentaje</option></select></label><label><span id="appointment-discount-value-label">Monto</span><input id="appointment-discount-value" type="number" min="0" step="1" inputmode="decimal"></label><button class="secondary" id="appointment-discount-submit" type="button">Aplicar</button></div><small id="appointment-discount-help">Se guarda como un monto nominal sobre el total del turno.</small></section>
              ...
              <section class="appointment-finance-form" id="appointment-payment-form"><strong>Registrar pago</strong><div class="appointment-finance-row"><label>Importe<input id="appointment-payment-amount" type="number" min="1" step="1" inputmode="numeric"></label><label>Medio<select id="appointment-payment-method"><option value="CASH">Efectivo</option><option value="TRANSFER">Transferencia / Mercado Pago</option><option value="CARD">Tarjeta</option></select></label><button class="secondary" id="appointment-add-payment-line" type="button">Pago mixto</button></div><div class="appointment-finance-row" id="appointment-payment-line-two" hidden><label>Segundo importe<input id="appointment-payment-amount-two" type="number" min="1" step="1" inputmode="numeric"></label><label>Segundo medio<select id="appointment-payment-method-two"><option value="CASH">Efectivo</option><option value="TRANSFER">Transferencia / Mercado Pago</option><option value="CARD">Tarjeta</option></select></label><span></span></div><label>Observaci&oacute;n<input id="appointment-payment-observation" maxlength="500"></label><button class="primary" id="appointment-payment-submit" type="button">Registrar pago</button></section>
...
export const cashRegisterScript = `
    const cashUi = {
      ...
      finance: document.getElementById('appointment-finance'), financeBalance: document.getElementById('appointment-finance-balance'), financeTotal: document.getElementById('appointment-finance-total'), financePaid: document.getElementById('appointment-finance-paid'), financeDue: document.getElementById('appointment-finance-due'), financeHistory: document.getElementById('appointment-finance-history'), financeFeedback: document.getElementById('appointment-finance-feedback'), totalForm: document.getElementById('appointment-total-form'), totalSubmit: document.getElementById('appointment-total-submit'), estimatedTotal: document.getElementById('appointment-estimated-total'), fixedTotalNote: document.getElementById('appointment-fixed-total-note'), discountForm: document.getElementById('appointment-discount-form'), discountSubmit: document.getElementById('appointment-discount-submit'), discountType: document.getElementById('appointment-discount-type'), discountValue: document.getElementById('appointment-discount-value'), discountValueLabel: document.getElementById('appointment-discount-value-label'), discountHelp: document.getElementById('appointment-discount-help'), paymentForm: document.getElementById('appointment-payment-form'), paymentSubmit: document.getElementById('appointment-payment-submit'), paymentAmount: document.getElementById('appointment-payment-amount'), paymentMethod: document.getElementById('appointment-payment-method'), paymentLineTwo: document.getElementById('appointment-payment-line-two'), paymentAmountTwo: document.getElementById('appointment-payment-amount-two'), paymentMethodTwo: document.getElementById('appointment-payment-method-two'), addPaymentLine: document.getElementById('appointment-add-payment-line'), paymentObservation: document.getElementById('appointment-payment-observation'), cashRequired: document.getElementById('appointment-cash-required'), appointmentOpenCash: document.getElementById('appointment-open-cash')
    }
